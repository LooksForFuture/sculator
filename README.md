...
You can also define your own functions in sculator too. For example x = lambda m:m**2-3. As you see, sculator has been written in python. So it uses python's syntax.
